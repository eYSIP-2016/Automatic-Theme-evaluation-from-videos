...
Input: Height, Width of the patch and the kernel type that is to formed
Output: kernel and the its gradient
Logic: Gaussian or Epanechikov kernel for 2-Dimension
%}
